...
export function Panel({
  ...
  return (
    <div className={`rounded-2xl border border-slate-200/80 bg-white p-5 sm:p-6 shadow-xs dark:border-slate-800/80 dark:bg-slate-900/90 ${className}`}>
      {(title || description) && (
...
export function EmptyState({ title, description }: { title: string; description?: string }) {
  return (
    <div className="rounded-2xl border border-dashed border-slate-300/80 bg-slate-50/50 p-8 sm:p-10 text-center dark:border-slate-800 dark:bg-slate-900/40">
...
export function StatCard({
  ...
  return (
    <article className={`rounded-2xl border border-slate-200/80 bg-white shadow-xs transition-all hover:shadow-md dark:border-slate-800/80 dark:bg-slate-900/90 ${compact ? 'p-4' : 'p-5.5'}`}>
...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-slate-950/60 backdrop-blur-xs p-3 sm:p-4" onClick={onClose}>
      <div
        role="dialog"
        aria-modal="true"
        className={`flex max-h-[90vh] w-full flex-col overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-slate-900 dark:border dark:border-slate-800/90 ${wide ? 'max-w-4xl' : 'max-w-md'}`}
...
export const inputClass =
  'w-full min-w-0 rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-sm outline-none transition-all duration-150 focus:border-brand focus:ring-2 focus:ring-brand/20 disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100 dark:placeholder-slate-500 dark:focus:border-brand dark:focus:ring-brand/30'

export const btnPrimary =
  'inline-flex items-center justify-center rounded-xl bg-brand px-4 py-2.5 text-sm font-semibold text-white shadow-xs shadow-brand/20 hover:bg-brand-dark transition-all duration-150 active:scale-[0.98] disabled:opacity-50 cursor-pointer'

export const btnSecondary =
  'inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 transition-all duration-150 disabled:opacity-50 dark:border-slate-800 dark:bg-slate-800/80 dark:text-slate-200 dark:hover:bg-slate-800 cursor-pointer'

export const btnDanger =
  'inline-flex items-center justify-center rounded-xl border border-red-200 bg-white px-4 py-2.5 text-sm font-semibold text-red-700 hover:bg-red-50 transition-all duration-150 disabled:opacity-50 dark:border-red-900/60 dark:bg-red-950/60 dark:text-red-300 dark:hover:bg-red-900/50 cursor-pointer'

export const btnSuccess =
  'inline-flex items-center justify-center rounded-xl bg-emerald-600 px-4 py-2.5 text-sm font-semibold text-white shadow-xs shadow-emerald-600/20 hover:bg-emerald-700 transition-all duration-150 active:scale-[0.98] disabled:opacity-50 cursor-pointer'

export const btnWarning =
  'inline-flex items-center justify-center rounded-xl border border-amber-300 bg-amber-50 px-4 py-2.5 text-sm font-semibold text-amber-800 hover:bg-amber-100 transition-all duration-150 disabled:opacity-50 dark:border-amber-800/60 dark:bg-amber-950/60 dark:text-amber-300 dark:hover:bg-amber-900/50 cursor-pointer'
